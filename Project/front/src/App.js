           ...
           {p._id === currentPlaceId && (
              ...
              >
                <div className="card">
                  ...
                  <span className="username">Created by <bold>{p.username}</bold></span>
...
{      newPlace && (
             <Popup
              ...
              >
                ...
                <form onSubmit={handleSumit}>
                    ...
                    <label>Review</label>
                    <textarea  onChange= {(e) => setDesc(e.target.value)} placeholder="Say something about this place."/> 
                    <label>Rating</label>
   ...
   <button onClick= {() => setShowRegister(true)} className='button register'>Register</button>
         ...
         
        {
         ...
         {
          showLogin && ( <Login setCurrentUser={setCurrentUser} myStorage={myStorage} setShowLogin={setShowLogin} />)
        }
       </ReactMapGL>
